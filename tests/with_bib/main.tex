...
\begin{theorem}[Some theorem]\label{thm:convergence}
Neural networks trained with Adam converge under mild conditions \cite{kingma2014adam}.
\end{theorem}

\begin{proof}[Proof of \ref{cor:stuff}]
Here's a proof of the corollary.
\end{proof}

\begin{proof}[Another proof of \ref{cor:stuff}]
Here's yet another proof of the corollary.
\end{proof}
